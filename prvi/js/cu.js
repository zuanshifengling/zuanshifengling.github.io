        ...
        $("body").click(
            function(e) { 
                ...
                $i.css({ 
                    ...
                    "-o-user-select": "none",
                    "user-select": "none",
                    "z-index": 999, "top": y - 20, "left": x, "position": "fixed", "font-weight": "bold", 
                    "color": "#ff6651" 
                    /*随机颜色写法："rgb(" + ~~(255 * Math.random()) + "," + ~~(255 * Math.random()) + "," + ~~(255 * Math.random()) + ")"*/ }); 
                    $("body").append($i); 
...
document.addEventListener('visibilitychange', function() {
	if (document.hidden) {
		...
		document.title = '(ฅ>ω<*ฅ) 噫又好啦 ~ 嘻嘻，你上当啦' + OriginTitle;
...
var now = new Date(); 
function createtime() { 
    var grt= new Date("7/25/2023 01:18:00");//在此处修改你的建站时间，格式：月/日/年 时:分:秒
